...
<body class="bg-gray-50 min-h-screen flex items-center justify-center px-6">
    <div class="text-center max-w-md">
        ...
        <p class="text-gray-500 mb-8">It looks like the apartment you're looking for doesn't exist or has been removed
            by the owner.</p>
        <a href="{{ route('apartments.index') }}"
            class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-xl text-white bg-teal-600 hover:bg-teal-700 transition">
